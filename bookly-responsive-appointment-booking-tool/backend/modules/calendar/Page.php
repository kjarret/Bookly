    ...
    public static function buildAppointmentsForCalendar(Lib\Query $query, $display_tz)
    {
        ...
        foreach ($appointments as $key => $appointment) {
            ...
            $appointments[$key] = array(
                ...
                'extendedProps' => array(
                    'tooltip' => Lib\Utils\Codes::stringify(
                        $appointment['duration'] >= DAY_IN_SECONDS ? $tooltip_all_day : $tooltip,
                        $codes,
                        false,
                        array(),
                        true
                    ...
                    'staff_name' => $appointment['staff_name'], // Ajouté
                    'customer_name' => $appointment['client_name'], // Ajouté
